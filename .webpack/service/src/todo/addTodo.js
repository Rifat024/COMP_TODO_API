...
const jmespath = __webpack_require__(/*! jmespath */ "./node_modules/pino-pretty/node_modules/jmespath/jmespath.js")
const colors = __webpack_require__(/*! ./lib/colors */ "./node_modules/pino-pretty/lib/colors.js")
const { ERROR_LIKE_KEYS, MESSAGE_KEY, TIMESTAMP_KEY } = __webpack_require__(/*! ./lib/constants */ "./node_modules/pino-pretty/lib/constants.js")
const {
  isObject,
  prettifyErrorLog,
  prettifyLevel,
...
const bourne = __webpack_require__(/*! @hapi/bourne */ "./node_modules/pino-pretty/node_modules/@hapi/bourne/lib/index.js")
...
/***/ "./node_modules/pino-pretty/node_modules/@hapi/bourne/lib/index.js":
/*!*************************************************************************!*\
  !*** ./node_modules/pino-pretty/node_modules/@hapi/bourne/lib/index.js ***!
  \*************************************************************************/
...
/***/ "./node_modules/pino-pretty/node_modules/jmespath/jmespath.js":
/*!********************************************************************!*\
  !*** ./node_modules/pino-pretty/node_modules/jmespath/jmespath.js ***!
  \********************************************************************/
/***/ ((__unused_webpack_module, exports) => {
...
function getPrettyStream (opts, prettifier, dest, instance) {
  ...
  try {
    const prettyFactory = (__webpack_require__(/*! pino-pretty */ "./node_modules/pino-pretty/index.js").prettyFactory) || __webpack_require__(/*! pino-pretty */ "./node_modules/pino-pretty/index.js")
...
const { mixinMergeStrategySym } = __webpack_require__(/*! ./lib/symbols */ "./node_modules/pino/lib/symbols.js")
const {
  chindingsSym,
  redactFmtSym,
  serializersSym,
...
/***/ "./src/commons/http-helpers/api-response.js":
/*!**************************************************!*\
  !*** ./src/commons/http-helpers/api-response.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _utils_logger__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/logger */ "./src/commons/utils/logger.js");
...
function apiResponse(response) {
  ...
  _utils_logger__WEBPACK_IMPORTED_MODULE_1__.log.debug(`response from apiResponse ==> ${JSON.stringify(response)}`);
  const httpResponse = {
    statusCode: 200,
    headers: {
  ...
  _utils_logger__WEBPACK_IMPORTED_MODULE_1__.log.debug('apiResponse: ' + JSON.stringify(httpResponse));
  return httpResponse;
}


function apiError(statusCode, errorDesc) { 
  _utils_logger__WEBPACK_IMPORTED_MODULE_1__.log.debug('errorDesc: ' + JSON.stringify(errorDesc));
  const response = {
  ...
  _utils_logger__WEBPACK_IMPORTED_MODULE_1__.log.debug('api error Response: ' + JSON.stringify(response));
  return response;
}

/***/ }),

/***/ "./src/commons/utils/logger.js":
/*!*************************************!*\
  !*** ./src/commons/utils/logger.js ***!
  \*************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _commons_http_helpers_api_response__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../commons/http-helpers/api-response */ "./src/commons/http-helpers/api-response.js");
/* harmony import */ var uuid__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! uuid */ "./node_modules/uuid/dist/esm-node/v4.js");




const addTodo = async (record) => {
    let recordObj = JSON.parse(record["body"]);
    recordObj.todoId = (0,uuid__WEBPACK_IMPORTED_MODULE_1__["default"])();
    recordObj.todoName = "test1";


    return (0,_commons_http_helpers_api_response__WEBPACK_IMPORTED_MODULE_0__.apiResponse)(recordObj);
